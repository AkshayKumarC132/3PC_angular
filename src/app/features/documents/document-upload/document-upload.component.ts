...
export class DocumentUploadComponent implements OnInit {
  ...
  // Align with UI copy: true 50MB cap
  ...
  onSubmit() {
    if (this.selectedFile && this.uploadForm.valid) {
      ...
      const uploadData = {
        // If your DocumentService expects 'document_file' instead of 'file_path', adjust this key.
      ...
      this.documentService.uploadDocument(uploadData).subscribe({
        next: () => {
          // API finished early; complete bar smoothly
