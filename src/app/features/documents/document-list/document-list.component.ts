        ...
        <div *ngIf="documents.length > 0" class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr *ngFor="let doc of documents; trackBy: trackById" class="hover:bg-gray-50" [attr.data-testid]="'document-row-' + doc.id">
                <!-- Make name clickable to navigate to detail page -->
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  ...
                  <div class="text-xs text-gray-500 truncate max-w-xs" [title]="doc.original_filename">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                  <span [ngClass]="getStatusClass(doc.upload_status)" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full capitalize">
                    {{ doc.upload_status || 'unknown' }}
                  </span>
                </td>

                <td class="px-6 py-4 whitespace-nowrap text-sm">
                  <span *ngIf="doc.rag_enabled" class="text-green-600 font-semibold">✓ Yes</span>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <button
                    ...
                    [attr.data-testid]="'delete-document-' + doc.id"
...
export class DocumentListComponent implements OnInit {
  ...
  trackById = (_: number, row: ReferenceDocument) => row.id;
  ...
  deleteDocument(documentId: string) {
    if (confirm('Are you sure you want to delete this document?')) {
      this.documentService.deleteDocument(documentId).subscribe({
        ...
        error: () => this.errorMessage = 'Failed to delete document'
      });
    }
  }
